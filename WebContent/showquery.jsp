      ...
      <div class="wrap">
                      ...
                      <div class="pull-right ">
                       ...
                       <div id="search-form" class="pull-left">
                        ...
                        <div  class="pull-right login" >
                              <a id="islogin" class=" pull-right"  style="display:none" href="manage_login.jsp">Login Now</a>
                           </div>
         ...
         <div id="main">
			...
			<input class="btn-small btn-color btn-pad" type="button" value="查询" id="submit"></div>
					...
					<input type="button" id="a1" value="首页" class="own-btn"/>
					<input type="button" id="a2" value="上一页" class="own-btn"/>
					<input type="button" id="a3" value="下一页" class="own-btn"/>
					<input type="button" id="a4" value="尾页" class="own-btn"/>
					共<input type="text" id="tol" disabled="disabled" class="own-text"/>页
