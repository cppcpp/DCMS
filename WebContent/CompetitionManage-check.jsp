			...
			<s:iterator value="list" id="x" >
				<div class="row panel  bk-bg-very-light-gray bk-border-off">
					<div class="col-md-10 col-md-offset-1">
						...
						<hr>
						<div class="row">
                            <div class="col-md-1 text-right">浏览次数:</div>
                            <div class="col-md-1">${applicationScope.counter}</div>
                            <div class="col-md-1 text-right">发布者:</div>
                        <div class="col-md-1"><s:property value="#x.issuer"/></div>
                            <div class="col-md-1 text-right">发布时间:</div>
                            <div class="col-md-2"><s:property value="#x.publishTime"/></div>
                            <div class="col-md-1 text-right">竞赛级别:</div>
                            <div class="col-md-1"><s:property value="#x.scale"/></div>
                            <div class="col-md-1 text-right">竞赛类型:</div>
				            <div class="col-md-1"><s:property value="#x.type"/></div>
						</div>
						<div class="row">
                           <div class="col-md-2 text-center">开始报名时间:<s:date name="#x.enterStart" format="yyyy-MM-dd" /></div>
                            <div class="col-md-2 text-right">截止报名时间:<s:date name="#x.enterStop" format="yyyy-MM-dd" /></div>
                            <div class="col-md-1 text-right">举办单位:</div>
                            <div class="col-md-2"><s:property value="#x.holdingUnit"/></div>
                            
						</div>
						<div class="row">
							<div class="col-md-10 bk-padding-10 text-justify">
								<textarea class="checktextarea" cols="160" rows="15">
