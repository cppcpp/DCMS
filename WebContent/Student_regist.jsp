							...
							<div class="panel-body">
								<form action="regist_Student.action" method="post">
									<div class="form-group">
										<label>用户名</label><span id="spanId" style="color:red"></span>
										<input name="student.studentId" type="text" id="stuId" onkeyUp="return stuIdCheck()" class="form-control" />
										
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												<label>密码</label><span id="spanPass" style="color:red"></span>
												<input name="student.studentPassword" type="password" id="stuPassword" onkeyUp="stuPassCheck()" class="form-control" />
											</div>
											<div class="col-sm-6">
												<label>确认密码</label><span id="spanConPass" style="color:red"></span>
												<input id="stuConfirmPassword" type="password" onkeyUp="return checkConfirmPass()"class="form-control" />
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												<label>验证码</label><span id="spanCode" style="color:red"></span>
												<input name="rand" id="rand" type="text" placeholder="*区分大小写" onkeyUp="return codeCheck()"class="form-control"/>
											</div>
											<div class="col-sm-6">
												<img src="createCode.action" alt="加载失败，请点击" title="看不清，换一张" name="randomCode" id="randomCode" style="margin-top:23px">
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-sm-4 text-right">
											<button type="submit" id="registButton" class="btn btn-primary hidden-xs bk-margin-top-10" disabled="disabled">Register</button>
<!-- 											<button href="index.html" type="submit"  id="registButton2" class="btn btn-primary btn-block btn-lg visible-xs bk-margin-top-10">Register</button>
 -->										</div>
									</div>
