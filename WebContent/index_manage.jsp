								...
								<ul class="nav nav-sidebar">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<li><a href="noticemanage_query.jsp"><span class="text"> 公告管理</span></a></li>						
										</ul>
									</li>
									<li class="nav-parent nav-expanded active">
										...
										<ul class="nav nav-children">
											...
											<li><a href="newsManage.jsp"><span class="text"> 新闻管理</span></a></li>
										</ul>
									</li>
									<li class="nav-parent">
										<a>
								...
								<div class="panel-body bk-bg-very-light-gray text-center bk-padding-top-10 bk-padding-bottom-10">
									<div class="row">
										<div class="col-xs-8 text-left bk-vcenter">
											<h6 class="bk-margin-off bk-padding-left-20 bk-padding-right-20">新闻动态</h6>
										</div>
								...
								<div class="col-md-12">
									<div class="panel bk-widget bk-border-off bk-noradius bk-webkit-fix">
										<div class="panel-body bk-bg-very-light-gray text-center bk-padding-top-10 bk-padding-bottom-10">
											<div class="row">
												<div class="col-xs-8 text-left bk-vcenter">
													<h6 class="bk-margin-off bk-padding-left-20 bk-padding-right-20"><i class="fa fa-bullhorn"></i> 公告信息</h6>
												</div>
												<div class="col-xs-4 bk-vcenter text-right">
								...
								<div class="col-md-12">
									<div class="panel bk-widget bk-border-off bk-noradius">
										<div class="panel-body bk-bg-very-light-gray text-center bk-padding-top-10 bk-padding-bottom-10">
											<div class="row">
												<div class="col-xs-8 text-left bk-vcenter">
													<h6 class="bk-margin-off bk-padding-left-20 bk-padding-right-20">竞赛信息</h6>
												</div>
												<div class="col-xs-4 bk-vcenter text-right">
													<i class="fa fa-file-text-o"></i>
												</div>
								...
								<div class="col-md-12">
									<div class="panel bk-widget bk-border-off bk-noradius">
										<div class="panel-body bk-bg-very-light-gray text-center bk-padding-top-10 bk-padding-bottom-10">
											<div class="row">
												<div class="col-xs-8 text-left bk-vcenter">
													<h6 class="bk-margin-off bk-padding-left-20 bk-padding-right-20">成果模块</h6>
												</div>
												<div class="col-xs-4 bk-vcenter text-right">
