...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
   ...
   <body class="home">
                     ...
                     <div class="posts-block col-lg-12 col-md-12 col-sm-11 col-xs-12 ">
                        ...
                        <div class="content-top col-lg-12 col-md-12 col-sm-11 col-xs-12 ">
                          ...
                          <div class="col-lg-3 col-md-3 col-xs-12 col-sm-2 ">
   						...
   						<input type="text" class="form-control" id="comName"  name="competition.comName" value="" placeholder="请输入赛事名称">
   						</div>
   						<div class="col-lg-2 col-md-2 col-xs-12 col-sm-2 ">
					   		<select class="form-control" name="competition.scale" id="comScale">
				   		...
				   		<div class="col-lg-2 col-md-2 col-xs-12 col-sm-2 ">
				   		<select class="form-control" name="competition.type" id="comType">
				                <option value=null>请选择竞赛类型</option>
				   				<option value=0>竞赛</option>
				   				<option value=1>大创</option>	
				              </select>
				        </div>
					   		<div class="col-lg-3 col-md-3 col-xs-12 col-sm-2 ">
					   		<select class="form-control" name="competition.flag" id="comFlag">
					                <option value=null>请选择是否已经立项</option>
					        ...
					        <div class="col-lg-2 col-md-2 col-xs-12 col-sm-2 ">
					   		  <input type="button" id="submit" class="btn-small btn-color  btn-space" value="查询">
					   			</div>
					   		<!-- </form> -->
					                  </div>
                  <!-- content-top end -->
                 <div id="splitline" class=" col-lg-12 col-md-12 col-sm-11 col-xs-12 "></div>
			        <div class=" col-lg-12 col-md-12 col-sm-11 col-xs-12 ">
                        ...
                        <table id="mytable" class="table table-striped table-bordered">
                           <thead>
                              <tr>
                               <th class="col-lg-1 col-md-1 col-xs-1 col-sm-1 ">竞赛类型</th>
                                 <th class="col-lg-5 col-md-4 col-xs-4 col-sm-4 ">竞赛名称</th>
                                 <th class="col-lg-1 col-md-3 col-xs-3 col-sm-3 ">发布时间</th>
                                  <th class="col-lg-1 col-md-2 col-xs-2 col-sm-2 ">是否立项</th>
                                  <th colspan="2" class="col-lg-2 col-md-3 col-xs-2 col-sm-2 ">操作</th>
                           ...
                           <tbody id="myTable">
                             ...
                             <%--  <s:iterator value="list" var="x">
    							<tr>
    								<td><s:if test="#x.type == 1">大创</s:if>
										<s:else>竞赛</s:else></td>
    								<td id="comName"><s:property value="#x.comName"/></td>
    								<td id="publishTime"><s:date name="#x.publishTime" format="yyy/MM/dd" /></td>
    								<td><s:if test="#x.flag == 1">已立项</s:if>
										<s:else>未立项</s:else></td>
    								<td><a href="check.action?competition.comId=<s:property value="#x.comId"/>"><input type="button" value="查看"></a></td>
    								<td><a href="addsubcompetition.jsp?comId=<s:property value="#x.comId"/>"><input type="button" value="报名"></a></td>
    							</tr>
    						</s:iterator> --%>
      ...
      <script src="js/custom.js"></script>
   	  <script src="js/comPaging.js"></script>
