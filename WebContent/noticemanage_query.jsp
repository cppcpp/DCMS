					...
					$.ajax({
						...
						success: function (data) {
							...
							for (var i = 0; i < json.length; i++) {
								/*$("#mytable").append(
										$("<tr class='tr'><td class='titletd'>"+json[i].noticeContent
										...
										+"&nbsp;&nbsp;&nbsp;删除"+"</a></td></tr>"));*/
								$("#mytable").append("<tr class=\"tr\">" +
									"<td class=\"titletd\">" + json[i].noticeContent + "</td>" +
									"<td>" + json[i].noticeDate + "</td>" +
									"<td><a href=\"delnotice_input.action?notice.noticeId=" + json[i].noticeId + "\" class=\"btn-modify\"><i class=\"fa fa-edit \"></i>&nbsp;&nbsp;&nbsp;修改</a></td>" +
									"<td><a onclick=\"if(confirm('您确定要删除此公告吗？')==false) return false;\" href=\"delnotice?notice.noticeId=" + json[i].noticeId + "\"  class=\" btn-delete\"><i class=\"fa fa-trash-o \"></i>&nbsp;&nbsp;&nbsp;删除</a></td> " +
									"</tr>");
							}
