							...
							<div class="panel-body bk-bg-very-light-gray">
								<form class="form-horizontal" role="form" action="modifyNews.action" method="post" enctype="multipart/form-data">
							        <div class="form-group">
							          ...
							          <div class="col-md-6">
							          	 <input type="text" id="manage-name-inp" name="news.newsTitle" class="form-control" required placeholder="title" value="<s:property value="#request.newsTitle"/>">
							          </div>
							        </div>
							        <div class="form-group">
							          <label class="col-md-3 control-lable text-right" for="text-input">新闻发布者：</label>
							          <div class="col-md-3">
							          	 <input type="text" name="news.newsIssuer" class="form-control" id="manage-issuer-inp" placeholder="newsIssuer" required value="<s:property value="#request.newsIssuer"/>">
							          </div>
							        </div>
							        <div class="form-group">
							        ...
							        <div class="form-group">
							        	...
							        	<div class="row">
							        		<div class="col-md-offset-3 col-lg-7 col-md-7">
							          		 	<textarea  id="manage-content-inp" name="news.newsContent" required class="form-control" rows="13"><s:property value="#request.newsContent"/></textarea></span>
							         		</div>
							        	</div>
							        </div>
							        <div class="form-group">
