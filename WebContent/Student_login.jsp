<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="antlr.collections.List" import="java.net.URLDecoder"%>
...
for(Cookie c:cookies){
	if(c.getName().equals("user")){
		...
		Id=strs[0];
		Password=strs[1];
		System.out.print("前台：name："+Id+"password:"+Password);
		break;
	}
}
}
							...
							<div class="panel-body">
								<form action="login.action" method="post">
									<div class="form-group">
										<label>账 号</label><label style="color:red;font-family:'Microsoft Yahei'">${sessionScope.loginfail}${requestScope.loginAgainMessage}</label>
										<div class="input-group input-group-icon">
											<input type="text" name="Id" id="stuId" value="<%=Id%>" class="form-control bk-noradius" />
									...
									<div class="form-group">
										<label>密 码</label>									
										<div class="input-group input-group-icon">
											<input type="password" name="Password" id="stupassword" value="<%=Password%>" class="form-control bk-noradius" />
											<span class="input-group-addon">
												<span class="icon">
									...
									<div class="form-group">
										<label>验证码</label><label style="color:red;font-family:'Microsoft Yahei'">${sessionScope.codeWrong}</label>						
										<div class="input-group input-group-icon">
											<input type="text" name="Code" class="form-control bk-noradius" style="width:200px" placeholder="*区分大小写"/>
											<img src="createCode.action" style="margin-left:30px;cursor:pointer" alt="加载失败，请点击" title="看不清，换一张" name="randomCode" id="randomCode" >
										</div>
									</div>
