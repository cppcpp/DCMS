	...
	<%@ taglib uri="/struts-tags" prefix="s"%>
		...
		<![endif]-->
			...
			<body>
									...
									<div class="panel-body bk-bg-very-light-gray">
										<form class="form-horizontal" role="form" action="SaveCompetition" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" id="comname" name="competition.comName" class="form-control" placeholder="竞赛名称">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-lable text-right" for="text-input">举办单位：</label>
												<div class="col-md-6">
													<input type="text" id="holdingunit" name="competition.holdingUnit" class="form-control" placeholder="举办单位">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" id="issuer" name="competition.issuer" class="form-control" placeholder="竞赛发布者">
												</div>
											</div>
											<div class="form-group">
												<div class="row">
													<div class="col-md-3 col-md-3 col-sm-12 text-right">
														<label class=" control-lable" for="text-input">竞赛内容：</label>
													</div>
												</div>
												<div class="row">
													<div class="col-md-offset-3 col-lg-7 col-md-7">
														<textarea id="comcontent" name="competition.comContent" class="form-control" rows="10"></textarea>
													</div>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="row">
												<button type="submit" class="btn btn-success col-md-1 col-md-offset-5">提交</button>
											</div>
										</form>
									</div>
								</div>
				...
				<script src="assets/js/checkcompetition.js"></script>
